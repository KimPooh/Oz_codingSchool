# 웹 개발 트랙 프로젝트 1조 - 팀 규칙

**과제 진행 기간**: 7월 13일 ~ 7월 29일
**팀장**: 정다원
**팀원**: 김지현, 박강호, 임종경, 김현희
**Repository**: https://github.com/dungdada/Oz_codingSchool
...
### 1. Core Time (코어 타임)
- 과제 Core Time은 15:30 ~ 18:00(중간 출결 시간)으로 정한다.
- Core Time에는 가능한 한 팀 작업에 집중한다.
...
- 적절한 상태 코드를 반환한다: `200`, `201`, `204`, `400`, `404`, `422`, `500`

### 5. Pydantic 스키마 규칙
- 요청과 응답 스키마를 분리한다. (`UserCreate`, `UserUpdate`, `UserResponse`, `UserLogin`)
